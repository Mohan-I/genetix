...
<!-- ========== SECTION 10: TERMS, CONDITIONS & LEGAL DISCLAIMER ========== -->
<div class="section">
  <div class="section-title"><span class="section-number">10.</span> TERMS, CONDITIONS & LEGAL DISCLAIMER</div>
  <div style="font-size: 7.5pt; line-height: 1.5; color: #4b5563; background: #f9fafb; padding: 10px 14px; border: 1px solid #e5e7eb; border-radius: 4px;">
    <p style="margin-bottom: 6px;"><strong>1. Decision-Support Tool:</strong> This report is generated by an automated Bayesian probabilistic engine ("Genetix v4.2"). It serves exclusively as a decision-support artifact for clinical review and does not constitute a independent medical diagnosis.</p>
    <p style="margin-bottom: 6px;"><strong>2. Diagnostic Limitations:</strong> Predictions are dependent on supplied genomic and phenotypic inputs. Mathematical probabilities do not account for unmodeled biological variability, including <em>de novo</em> mutations, allele drop-outs, mosaicism, or rare polygenic variations.</p>
    <p style="margin-bottom: 6px;"><strong>3. Confirmatory Diagnostics:</strong> Statistical risk assessments must be confirmed via certified CLIA/CAP wet-lab diagnostics prior to clinical action.</p>
    <p style="margin-bottom: 0px;"><strong>4. Limitation of Liability:</strong> Developers and platform providers accept no direct liability for medical decisions made based on this algorithmic output.</p>
  </div>
</div>
...
<div class="footer">
  ...
  <p style="margin-top: 2px;">© 2026 Genetix Probability Engine &bull; Research &amp; Clinical Decision Support</p>
</div>
